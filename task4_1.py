...
# >python -m timeit -n 10000 -s "import task4_1" "task4_1.find_min_1(10)"
...
cProfile.run('find_min_1(10000)')


#  ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#       1    0.000    0.000    0.003    0.003 task4_1.py:8(find_min_1)      n=1000
#       1    0.001    0.001    0.006    0.006 task4_1.py:8(find_min_1)      n=2000
#       1    0.001    0.001    0.009    0.009 task4_1.py:8(find_min_1)      n=3000
#       1    0.003    0.003    0.031    0.031 task4_1.py:8(find_min_1)      n=10000
...
# проверка №1 с пом. timeit в терминале:
# >python -m timeit -n 10000 -s "import task4_1" "task4_1.find_min_2(10)"
...
# проверка №2 с пом. cProfile:
cProfile.run('find_min_2(10000)')


#  ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#       1    0.000    0.000    0.003    0.003 task4_1.py:45(find_min_2)      n=1000
#       1    0.000    0.000    0.006    0.006 task4_1.py:45(find_min_2)      n=2000
#       1    0.000    0.000    0.009    0.009 task4_1.py:45(find_min_2)      n=3000
#       1    0.000    0.000    0.029    0.029 task4_1.py:45(find_min_2)      n=10000
...
# проверка №1 с пом. timeit в терминале:
# >python -m timeit -n 10000 -s "import task4_1" "task4_1.find_min_3(10)"
...
# проверка №2 с пом. cProfile:
# cProfile.run('find_min_3(10000)')


#  ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#       1    0.000    0.000    0.003    0.003 task4_1.py:74(find_min_3)      n=1000
#       1    0.001    0.001    0.006    0.006 task4_1.py:74(find_min_3)      n=2000
#       1    0.001    0.001    0.009    0.009 task4_1.py:74(find_min_3)      n=3000
#       1    0.003    0.003    0.031    0.031 task4_1.py:74(find_min_3)      n=10000
...
# проверка №1 с пом. timeit в терминале:
# >python -m timeit -n 10000 -s "import task4_1" "task4_1.find_min_4(10)"
...
# проверка №2 с пом. cProfile:
# cProfile.run('find_min_4(10000)')


#  ncalls  tottime  percall  cumtime  percall filename:lineno(function)
#       1    0.000    0.000    0.003    0.003 task4_1.py:73(find_min_4)      n=1000
#       1    0.000    0.000    0.006    0.006 task4_1.py:73(find_min_4)      n=2000
#       1    0.000    0.000    0.009    0.009 task4_1.py:73(find_min_4)      n=3000
#       1    0.000    0.000    0.029    0.029 task4_1.py:73(find_min_4)      n=10000
